...
const PlayerSchema = new mongoose.Schema({
  ...
  isInsideLab: { type: Boolean, required: true },
  isInsideTower: { type: Boolean, required: true },
  isInsideHall: { type: Boolean, required: true },
  accessTowerID: { type: String, required: true },
