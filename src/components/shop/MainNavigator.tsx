      ...
      <div className="relative w-full h-[120px]">
        ...
        <div className="justify-center flex items-center text-center h-full relative z-1">
                <button
                    ...
                    className={`flex-1 h-5/6 w-2/3 font-semibold rounded-lg transition-all duration-100 group ${selected === 0 ? 'text-orange-400 text-5xl' : 'text-white text-4xl'} hover:bg-gray-400`}
                >
                <p className="text-center group-hover:text-orange-300 transition-all duration-100">EQUIPMENT</p>

            </button>

            <button
                onClick={() => handleButtonClick(1)} // Pasa el índice 1 al hacer clic
                className={`flex-1 h-5/6 w-2/3 font-semibold rounded-lg transition-all duration-100 group ${selected === 1 ? 'text-orange-400 text-5xl' : 'text-white text-4xl'} hover:bg-gray-400`}  
                >
                <p className="text-center group-hover:text-orange-300 transition-all duration-100   ">MAGIC STUFF</p>
