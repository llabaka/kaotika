...
const ArmorTooltip: React.FC<Props> = ({ element, equiped }): React.ReactNode => {
  return (
    <div key={element._id} className='w-full p-4 text-center'>
      <div className="flex flex-row justify-items-center items-center">
        ...
        <div className="w-full p-4">
          ...
          <h1 className="text-3xl mb-2 text-darkSepia">Min Level</h1>
          <p className="text-2xl mb-2 font-light">{equiped.min_lvl}</p>
          <h1 className="text-3xl mb-2 text-darkSepia">Defense</h1>
          <p className="text-2xl mb-2 font-light">{equiped.defense}</p>
          <h1 className="text-3xl mb-2 text-darkSepia">Value</h1>
          <p className="text-2xl mb-2 font-light">{equiped.value}</p>
          <h1 className="text-3xl mb-2 text-darkSepia">Modifiers</h1>
          {equiped.modifiers.constitution 
            ? <p className={equiped.modifiers.constitution > element.modifiers.constitution 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Constitution: {equiped.modifiers.constitution}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Constitution: 0</p>}
          {equiped.modifiers.charisma 
            ? <p className={equiped.modifiers.charisma > element.modifiers.charisma 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Charisma: {equiped.modifiers.charisma}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Charisma: 0</p>}
          {equiped.modifiers.dexterity 
            ? <p className={equiped.modifiers.dexterity > element.modifiers.dexterity 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Dexterity: {equiped.modifiers.dexterity}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Dexterity: 0</p>}
          {equiped.modifiers.insanity 
            ? <p className={equiped.modifiers.insanity > element.modifiers.insanity 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Insanity: {equiped.modifiers.insanity}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Insanity: 0</p>}
          {equiped.modifiers.intelligence 
            ? <p className={equiped.modifiers.intelligence > element.modifiers.intelligence 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Intelligence: {equiped.modifiers.intelligence}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Intelligence: 0</p>}
          {equiped.modifiers.strength 
            ? <p className={equiped.modifiers.strength > element.modifiers.strength 
              ? "text-2xl mb-2 text-green-600" 
              : "text-2xl mb-2 text-red-400"}>Strength: {equiped.modifiers.strength}</p> 
            : <p className="text-2xl mb-2 text-gray-400">Strength: 0</p>} 
        </div>
        : null } 
      </div>       
    </div>
